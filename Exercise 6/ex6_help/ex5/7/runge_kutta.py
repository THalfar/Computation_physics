...
def pend_ivp(t,y):
    # Extra parameters to the function that are needed for solve_ipv.
...
def odeint_test(ax):
    # Function that generates a graph of the solution and prints the maximum 
    # absolute value, using scipy.integrate.odeint.
    ...
    print("odeint maximum:")
    print(np.amax(abs(sol[:, 0])))

def runge_kutta_test(ax):
    # Function that generates a graph of the solution and prints the maximum 
    # absolute value, using the runge_kutta4 defined above.
    ...
    print("Runge-Kutta maximum:")
    print(np.amax(abs(sol[:, 0])))

def solve_ivp_test(ax):
    # Function that generates a graph of the solution and prints the maximum 
    # absolute value, using scipy.integrate.solve_ivp.
    ...
    print("solve_ipv maximum:")
    print(np.amax(abs(sol.y[0,:])))

def main():
    # Run test functions and make the plots.
